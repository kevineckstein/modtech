  ...
  return (
    <article className="min-h-full bg-gray-100">
      ...
      <section className="container flex flex-wrap items-center justify-center gap-1 mx-auto -mt-10 text-center lg:gap-8 ">
        <div className="z-10 flex items-center justify-center w-4/5 px-6 py-4 mx-auto mt-6 bg-white rounded-lg shadow-lg lg:h-service lg:mx-0 lg:w-1/4 hover:shadow-xl">
          <div>
